    ...
    return(
        <>
            ...
            <form onSubmit={handleSubmit}>
                <label htmlFor="titulo">Produto: </label><br />
                <input type="text" id="titulo" name="titulo" value={produto.titulo} onChange={handleChange}/><br />
                
                <label htmlFor="preco">Preço: </label><br />
                <input type="number" id="preco" name="preco" step="0.01" value={produto.preco} onChange={handleChange}/><br />

                <label htmlFor="quantidade">Quantidade: </label><br />
                <input type="number" id="quantidade" name="quantidade" value={produto.quantidade} onChange={handleChange}/><br />
