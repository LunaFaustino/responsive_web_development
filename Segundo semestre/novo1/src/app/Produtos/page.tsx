            ...
            <main className="pagina">
                <div className="customer360">
                    ...
                    <section className="produto2">
                        <img src="assets/customer2.png" alt="Mulher loira e homem moreno em vídeo chamada" />
                ...
                <div className="nuvemdedados">
                    <section className="produto1">
                        ...
                        <img src="assets/data1.png" alt="Logo da Nuvem de Dados" className="customerlogo" />
                    </section>
                ...
                <div className="marketingcloud">
                    <section className="produto1">
                        ...
                        <img src="assets/marketing1.png" alt="" className="customerlogo" />
                    </section>

                    <section className="produto2">
                        <img src="assets/marketing2.png" alt="Print de um celular mostrando telas do sistema Salesforce" />
                        <article className="artigo2">
